...
const serviceDetails = reactive({
  birthPlan: {
    ...
    tagline: "Ideal for first-time parents or anyone seeking clarity and confidence in their birth plan.",
    includes: [
      "60-90 minute tailored birth plan development based on your preferences and values",
  ...
  childbirth: {
    ...
    includes: [
      ...
      "Flexible delivery: In-person (Denver metro area), virtual, or hybrid options",
